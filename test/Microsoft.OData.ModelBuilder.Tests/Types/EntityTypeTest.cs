...
namespace Microsoft.OData.ModelBuilder.Tests.Types
{
    public class EntityTypeTest
    {
        ...
        public void CanCreateEntityWithPrimitiveAndEnumKey()
        {
            ...
            Assert.Equal("Microsoft.OData.ModelBuilder.Tests.TestModels.SimpleEnum", enumKey.Type.Definition.FullTypeName());
        ...
        {
            var builder = ODataModelBuilderMocks.GetModelBuilderMock();
            ...
            Assert.False(property.NullableProperty);
        ...
        public void HasKeyOnDerivedTypes_Throws_IfCallDerivedFromFirst_ThenHasKey()
        {
            ...
            ExceptionAssert.Throws<InvalidOperationException>(() => sportBikeType.DerivesFrom<Motorcycle>().HasKey(s => s.SportBikeProperty_NotVisible),
                "Cannot define keys on type 'Microsoft.OData.ModelBuilder.Tests.TestModels.SportBike' deriving from 'Microsoft.OData.ModelBuilder.Tests.TestModels.Motorcycle'. " +
        ...
        public void RedefiningBaseTypeProperty_Throws()
        {
            ...
            ExceptionAssert.ThrowsArgument(
                ...
                "propertyInfo",
                "Cannot redefine property 'WheelCount' already defined on the base type 'Microsoft.OData.ModelBuilder.Tests.TestModels.Vehicle'.");
        }
        ...
        public void DefiningPropertyOnBaseTypeAlreadyPresentInDerivedType_Throws()
        {
            ...
            ExceptionAssert.ThrowsArgument(
                () => builder
                        ...
                        .Property(v => v.Model),
                "propertyInfo",
                "Cannot define property 'Model' in the base type 'Microsoft.OData.ModelBuilder.Tests.TestModels.Vehicle' as the derived type 'Microsoft.OData.ModelBuilder.Tests.TestModels.Motorcycle' already defines it.");
        }
        ...
        public void DerivesFrom_Throws_IfDerivedTypeDoesntDeriveFromBaseType()
        {
            ...
            ExceptionAssert.ThrowsArgument(
                () => builder
                        ...
                        .DerivesFrom<Vehicle>(),
                "baseType",
                "'System.String' does not inherit from 'Microsoft.OData.ModelBuilder.Tests.TestModels.Vehicle'.");
        }
        ...
        public void DerivesFrom_Throws_WhenSettingTheBaseType_IfDuplicatePropertyInBaseType()
        {
            ...
            ExceptionAssert.ThrowsArgument(
                ...
                "propertyInfo",
                "Cannot redefine property 'Model' already defined on the base type 'Microsoft.OData.ModelBuilder.Tests.TestModels.Vehicle'.");
        }
        ...
        public void DerivesFrom_Throws_WhenSettingTheBaseType_IfDuplicatePropertyInDerivedType()
        {
            ...
            ExceptionAssert.ThrowsArgument(
                () => builder
                    ...
                    .DerivesFrom<Vehicle>(),
                "propertyInfo",
                "Cannot define property 'Model' in the base type 'Microsoft.OData.ModelBuilder.Tests.TestModels.Motorcycle' as the derived type 'Microsoft.OData.ModelBuilder.Tests.TestModels.SportBike' already defines it.");
        }
        ...
        public void CannotDeriveFromItself()
        {
            ...
            () => builder
                ...
                .DerivesFrom<Vehicle>(),
            "baseType",
            "'Microsoft.OData.ModelBuilder.Tests.TestModels.Vehicle' does not inherit from 'Microsoft.OData.ModelBuilder.Tests.TestModels.Vehicle'.");
        }
