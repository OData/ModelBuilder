...
{
    public class ODataConventionModelBuilderTest
    {
        private const int _totalExpectedSchemaTypesForVehiclesModel = 10;

        [Fact]
        public void Ctor_ThrowsForNullResolver()
        {
        ...
        public void RemoveBaseTypeProperties_RemovesAllBaseTypePropertiesFromDerivedTypes()
        {
            ...
            var builder = ODataConventionModelBuilderFactory.CreateWithTypes(mockType1, mockType2, mockType3);
        ...
        public void MapDerivedTypes_BringsAllDerivedTypes_InTheAssembly()
        {
            ...
            var builder = ODataConventionModelBuilderFactory.CreateWithTypes(mockType1, mockType2, mockType3, mockType4);
        ...
        public void ModelBuilder_ThrowsException_EntityType_AndDerivedTypesMappedDifferentTypesExplicitly()
        {
            ...
            ExceptionAssert.Throws<InvalidOperationException>(() => builder.GetEdmModel(),
                "Cannot determine the Edm type for the CLR type 'Microsoft.OData.ModelBuilder.Tests.TestModels.Animal' " +
                "because the derived type 'Microsoft.OData.ModelBuilder.Tests.TestModels.Horse' is configured as entity type and another " +
                "derived type 'Microsoft.OData.ModelBuilder.Tests.TestModels.Human' is configured as complex type.");
        }
        ...
        public void ModelBuilder_ThrowsException_EntityType_AndSubDerivedTypesMappedDifferentTypesExplicitly()
        {
            ...
            // Act & Assert
            ExceptionAssert.Throws<InvalidOperationException>(() => builder.GetEdmModel(),
                "Cannot determine the Edm type for the CLR type 'Microsoft.OData.ModelBuilder.Tests.TestModels.Plant' " +
                "because the derived type 'Microsoft.OData.ModelBuilder.Tests.TestModels.Jasmine' is configured as entity type and another " +
                "derived type 'Microsoft.OData.ModelBuilder.Tests.TestModels.Phycophyta' is configured as complex type.");
        }
        ...
        {
            // Arrange
            ODataConventionModelBuilder builder = ODataConventionModelBuilderFactory.Create(b => b.ModelAliasingEnabled = true);
        ...
        public void ModelBuilder_Figures_Bindings_For_DerivedNavigationProperties()
        {
            ...
            vehicles.AssertHasNavigationTarget(
                car.AssertHasNavigationProperty(model, "Manufacturer", typeof(CarManufacturer), isNullable: true, multiplicity: EdmMultiplicity.ZeroOrOne),
                "manufacturers", "Microsoft.OData.ModelBuilder.Tests.TestModels.Car/Manufacturer");
            vehicles.AssertHasNavigationTarget(
                motorcycle.AssertHasNavigationProperty(model, "Manufacturer", typeof(MotorcycleManufacturer), isNullable: true, multiplicity: EdmMultiplicity.ZeroOrOne),
                "manufacturers", "Microsoft.OData.ModelBuilder.Tests.TestModels.Motorcycle/Manufacturer");
            vehicles.AssertHasNavigationTarget(
                sportbike.AssertHasNavigationProperty(model, "Manufacturer", typeof(MotorcycleManufacturer), isNullable: true, multiplicity: EdmMultiplicity.ZeroOrOne),
                "manufacturers", "Microsoft.OData.ModelBuilder.Tests.TestModels.Motorcycle/Manufacturer");
        ...
        public void ModelBuilder_BindsToTheClosestEntitySet_ForNavigationProperties()
        {
            ...
            vehicles.AssertHasNavigationTarget(
                car.AssertHasNavigationProperty(model, "Manufacturer", typeof(CarManufacturer), isNullable: true, multiplicity: EdmMultiplicity.ZeroOrOne),
                "car_manufacturers", "Microsoft.OData.ModelBuilder.Tests.TestModels.Car/Manufacturer");
            vehicles.AssertHasNavigationTarget(
                motorcycle.AssertHasNavigationProperty(model, "Manufacturer", typeof(MotorcycleManufacturer), isNullable: true, multiplicity: EdmMultiplicity.ZeroOrOne),
                "motorcycle_manufacturers", "Microsoft.OData.ModelBuilder.Tests.TestModels.Motorcycle/Manufacturer");
            vehicles.AssertHasNavigationTarget(
                sportbike.AssertHasNavigationProperty(model, "Manufacturer", typeof(MotorcycleManufacturer), isNullable: true, multiplicity: EdmMultiplicity.ZeroOrOne),
                "motorcycle_manufacturers", "Microsoft.OData.ModelBuilder.Tests.TestModels.Motorcycle/Manufacturer");
        ...
        public void ModelBuilder_BindsToAllEntitySets()
        {
            ...
            IEdmEntitySet vehicles = model.EntityContainer.FindEntitySet("vehicles");
            Assert.Equal(2, vehicles.NavigationPropertyBindings.Count());
            Assert.Equal("Microsoft.OData.ModelBuilder.Tests.TestModels.Car/Manufacturer", vehicles.NavigationPropertyBindings.First().Path.Path);
            Assert.Equal("Microsoft.OData.ModelBuilder.Tests.TestModels.Motorcycle/Manufacturer", vehicles.NavigationPropertyBindings.Last().Path.Path);
        ...
        public void ModelBuilder_OnSingleton_BindsToAllEntitySets()
        {
            ...
            Assert.Equal("Microsoft.OData.ModelBuilder.Tests.TestModels.Car/Manufacturer", vehicle.NavigationPropertyBindings.First().Path.Path);
            Assert.Equal("Microsoft.OData.ModelBuilder.Tests.TestModels.Motorcycle/Manufacturer", vehicle.NavigationPropertyBindings.Last().Path.Path);
        ...
        public void ModelBuilder_BindingsTo_WithComplexTypePath()
        {
            ...
            // for entity set
            Assert.Equal(2, vehicles.NavigationPropertyBindings.Count());
            vehicles.AssertHasNavigationTarget(addressNav, "Addresses", "Microsoft.OData.ModelBuilder.Tests.TestModels.Car/Manufacturer/Address");
            vehicles.AssertHasNavigationTarget(addressNav, "Addresses", "Microsoft.OData.ModelBuilder.Tests.TestModels.Motorcycle/Manufacturer/Address");

            // for singleton
            Assert.Equal(2, singleton.NavigationPropertyBindings.Count());
            singleton.AssertHasNavigationTarget(addressNav, "Addresses", "Microsoft.OData.ModelBuilder.Tests.TestModels.Car/Manufacturer/Address");
            singleton.AssertHasNavigationTarget(addressNav, "Addresses", "Microsoft.OData.ModelBuilder.Tests.TestModels.Motorcycle/Manufacturer/Address");
        }
        ...
        public void ModelBuilder_BindingsTo_WithComplexTypePath_BindAllPathToEntitySet()
        {
            ...
            foreach (var navigation in new[] { "City", "Cities" })
            {
                ...
                customers.AssertHasNavigationTarget(nav, "Cities", "Microsoft.OData.ModelBuilder.Tests.Containers.BindingVipCustomer/VipLocation/" + navigation);
                customers.AssertHasNavigationTarget(nav, "Cities", "Microsoft.OData.ModelBuilder.Tests.Containers.BindingVipCustomer/VipAddresses/" + navigation);
            }

            foreach (var navigation in new[] { "UsCity", "UsCities" })
            {
                IEdmNavigationProperty nav = navigation == "UsCity" ? usCityNav : usCitiesNav;
                customers.AssertHasNavigationTarget(nav, "Cities", "Location/Microsoft.OData.ModelBuilder.Tests.Containers.BindingUsAddress/" + navigation);
                customers.AssertHasNavigationTarget(nav, "Cities", "Address/Microsoft.OData.ModelBuilder.Tests.Containers.BindingUsAddress/" + navigation);
                customers.AssertHasNavigationTarget(nav, "Cities", "Addresses/Microsoft.OData.ModelBuilder.Tests.Containers.BindingUsAddress/" + navigation);
                customers.AssertHasNavigationTarget(nav, "Cities", "Microsoft.OData.ModelBuilder.Tests.Containers.BindingVipCustomer/VipLocation/Microsoft.OData.ModelBuilder.Tests.Containers.BindingUsAddress/" + navigation);
                customers.AssertHasNavigationTarget(nav, "Cities", "Microsoft.OData.ModelBuilder.Tests.Containers.BindingVipCustomer/VipAddresses/Microsoft.OData.ModelBuilder.Tests.Containers.BindingUsAddress/" + navigation);
            }
        }
        ...
        public void ModelBuilder_DerivedTypeDeclaringKeyThrows()
        {
            ...
            var builder = ODataConventionModelBuilderFactory.CreateWithTypes(baseType, derivedType);
        ...
        public void ModelBuilder_DeclareKeyOnDerivedTypeAndSubDerivedType_Throws()
        {
            ...
            ExceptionAssert.Throws<InvalidOperationException>(
                () => builder.GetEdmModel(),
            "Cannot define keys on type 'Microsoft.OData.ModelBuilder.Tests.SubSubEntityTypeWithOwnKey' deriving from 'Microsoft.OData.ModelBuilder.Tests.SubEntityTypeWithOwnKey'. " +
            "The base type in the entity inheritance hierarchy already contains keys.");
        }
        ...
        public void ModelBuilder_DeclareEntitySetOnAbstractEntityTypeWithoutKeyThrows()
        {
            ...
            ExceptionAssert.Throws<InvalidOperationException>(
                () => builder.GetEdmModel(),
            "The entity set 'entitySet' is based on type 'Microsoft.OData.ModelBuilder.Tests.AbstractEntityType' that has no keys defined.");
        }
        ...
        public void DerivedTypes_Can_DefineKeys_InQueryCompositionMode()
        {
            ...
            var builder = ODataConventionModelBuilderFactory.CreateWithTypes(true, baseType, derivedType);
        ...
        public void DerivedTypes_Can_DefineEnumKeys_InQueryCompositionMode()
        {
            ...
            Assert.Equal("Microsoft.OData.ModelBuilder.Tests.TestModels.Color", key.Type.Definition.FullTypeName());
            ...
            Assert.Equal("Microsoft.OData.ModelBuilder.Tests.TestModels.Color", derivedId.Type.Definition.FullTypeName());
        }
        ...
        public void ModelBuilder_DerivedComplexTypeHavingKeys_Throws()
        {
            ...
            var builder = ODataConventionModelBuilderFactory.CreateWithTypes(baseComplexType, derivedComplexType, entityType);
        ...
        public void CanBuildModelForAnonymousTypes()
        {
            ...
            ODataConventionModelBuilder builder = ODataConventionModelBuilderFactory.Create(isQueryCompositionMode: true);
        ...
        public void DerivedComplexTypes_AreFlattened()
        {
            ...
            ODataConventionModelBuilder builder = ODataConventionModelBuilderFactory.CreateWithTypes(complexBase, complexDerived);
        ...
        public void OnModelCreating_IsInvoked_AfterConventionsAreRun()
        {
            ...
            builder.OnModelCreating = (modelBuilder) =>
            {
                ...
                // mark the key as nullable just to verify later.
                key.NullableProperty = true;
            };
        ...
        public void IgnoredPropertyOnBaseType_DoesnotShowupOnDerivedType()
        {
            ...
            var builder = ODataModelBuilderMocks.MockConventionModelBuilder(baseType, derivedType);
        ...
        public void IgnoredPropertyOnBaseComplexType_DoesnotShowupOnDerivedComplexType()
        {
            ...
            ODataConventionModelBuilder builder = ODataConventionModelBuilderFactory.CreateWithTypes(baseType, derivedType);
        ...
        public void GetEdmModel_WorksOnConventionModelBuilder_ForOpenEntityType()
        {
            // Arrange
            ODataConventionModelBuilder builder = ODataConventionModelBuilderFactory.Create();
            builder.EntityType<SimpleOpenEntityType>();
        ...
        [Fact]
        public void GetEdmModel_WorksOnConventionModelBuilder_ForEntityType_InstanceAnnotation()
        {
            // Arrange
            ODataConventionModelBuilder builder = ODataConventionModelBuilderFactory.Create();
        ...
        [Fact]
        public void GetEdmModel_WorksOnConventionModelBuilder_ForDerivedEntityType()
        {
            // Arrange
            ODataConventionModelBuilder builder = ODataConventionModelBuilderFactory.Create();
            builder.EntityType<EntityTypeWithAnnotation>();
        ...
        public void GetEdmModel_CreatesNavigationPropertyBindings_ForMutuallyRecursiveLoopOfComplexTypes()
        {
            ...
            Assert.Collection(
                ...
                nav => Assert.Equal("ResponsibleGuardian/Microsoft.OData.ModelBuilder.Tests.TestModels.Child/Car", nav.Path.Path),
        ...
        public void ConventionModelBuilder_Work_With_ExpilitPropertyDeclare()
        {
            ...
            user.EntityType.Property(p => p.Name).IsNullable();
