...
namespace Microsoft.OData.ModelBuilder.Tests.Containers
{
    public class BindingPathConfigurationOfTStructuralTypeTest
    {
        ...
        public void HasManyPath_AddBindindPath_Derived(bool contained)
        {
            ...
            Assert.IsType<BindingPathConfiguration<BindingAddress>>(newBinding);
            Assert.Equal("Microsoft.OData.ModelBuilder.Tests.Containers.BindingVipCustomer/VipAddresses", newBinding.BindingPath);
        }
        ...
        public void HasSinglePath_AddBindindPath(bool required, bool contained)
        {
            ...
            else
            {
                ...
                Assert.Equal(!required, complexProperty.NullableProperty);
        ...
        public void HasSinglePath_AddBindindPath_Derived(bool required, bool contained)
        {
            ...
            Assert.IsType<BindingPathConfiguration<BindingAddress>>(newBinding);
            Assert.Equal("Microsoft.OData.ModelBuilder.Tests.Containers.BindingVipCustomer/VipLocation", newBinding.BindingPath);
        }
        ...
        public void HasManyBinding_AddBindindToNavigationSource_Derived()
        {
            ...
            Assert.Equal("Microsoft.OData.ModelBuilder.Tests.Containers.BindingVipCustomer/VipAddresses/Microsoft.OData.ModelBuilder.Tests.Containers.BindingUsAddress/UsCities", binding.BindingPath);
        }
        ...
        public void HasRequiredBinding_AddBindindToNavigationSource_Derived()
        {
            ...
            Assert.Equal("Microsoft.OData.ModelBuilder.Tests.Containers.BindingVipCustomer/VipLocation/Microsoft.OData.ModelBuilder.Tests.Containers.BindingUsAddress/UsCity", binding.BindingPath);
        }
