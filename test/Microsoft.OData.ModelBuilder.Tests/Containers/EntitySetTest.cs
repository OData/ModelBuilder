...
namespace Microsoft.OData.ModelBuilder.Tests.Containers
{
    public class EntitySetTest
    {
        ...
        public void CanAddBinding_For_DerivedNavigationProperty()
        {
            ...
            var binding = Assert.Single(entitySet.FindNavigationPropertyBindings(edmNavProperty));
            Assert.Same(target, binding.Target);
            Assert.Equal("Microsoft.OData.ModelBuilder.Tests.TestModels.Motorcycle/Manufacturer", binding.Path.Path);
        }
        ...
        public void CanConfigureManyBinding_For_NavigationPropertiesInDerivedType()
        {
            ...
            IEdmNavigationPropertyBinding binding = Assert.Single(vehicles.FindNavigationPropertyBindings(motorcycleManufacturerProperty));
            Assert.Same(motorcycleManufacturerPropertyTargetSet, binding.Target);
            Assert.Equal("Microsoft.OData.ModelBuilder.Tests.TestModels.Motorcycle/Manufacturers", binding.Path.Path);
        }
        ...
        public void CanConfigureBindingPath_NavigationProperties_WithDerivedType()
        {
            ...
            Assert.Equal("Microsoft.OData.ModelBuilder.Tests.Containers.BindingVipCustomer/VipLocation/Microsoft.OData.ModelBuilder.Tests.Containers.BindingUsAddress/UsCity", binding.Path.Path);
            ...
            Assert.Equal("Microsoft.OData.ModelBuilder.Tests.Containers.BindingVipCustomer/VipLocation/Microsoft.OData.ModelBuilder.Tests.Containers.BindingUsAddress/UsCities", binding.Path.Path);
