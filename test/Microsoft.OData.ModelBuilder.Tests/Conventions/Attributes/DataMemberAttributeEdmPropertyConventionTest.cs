...
namespace Microsoft.OData.ModelBuilder.Conventions.Attributes.Tests
{
    public class DataMemberAttributeEdmPropertyConventionTest
    {
        ...
        {
            // Arrange
            ODataConventionModelBuilder modelBuilder = ODataConventionModelBuilderFactory.Create(b => b.ModelAliasingEnabled = modelAliasing);
        ...
        public void DataMemberAttributeEdmPropertyConvention_DoesnotOverwriteExistingConfiguration()
        {
            ...
            ODataConventionModelBuilder builder = ODataConventionModelBuilderFactory.Create();
            builder.AddEntityType(type).AddProperty(type.GetProperty("Count")).IsNullable();
