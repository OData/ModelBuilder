...
namespace Microsoft.OData.ModelBuilder
{
    ...
    public abstract class PropertyConfiguration
    {
        ...
        {
            QueryConfiguration.SetCount(enabled);
            return this;
        }
        ...
        {
            return OrderBy(true, properties);
        }
        ...
        {
            return OrderBy(enabled, null);
        }

        /// <summary>
        /// Sets sortable properties depends on boolean of this property.
        /// </summary>
        public PropertyConfiguration OrderBy(bool enabled, params string[] properties)
        {
            QueryConfiguration.SetOrderBy(properties, enabled);
            return this;
        }
        ...
        {
            return Filter(enabled, null);
        }

        /// <summary>
        /// Sets filterable properties depends on boolean of this property.
        /// </summary>
        public PropertyConfiguration Filter(bool enabled, params string[] properties)
        {
            QueryConfiguration.SetFilter(properties, enabled);
            return this;
        }
