...
namespace Microsoft.OData.Extensions.Builder
{
    ...
    public class NavigationPropertyConfiguration : PropertyConfiguration
    {
        ...
        /// <summary>
        /// Marks the navigation property as nullable.
        /// </summary>
        ...
        /// <summary>
        /// Marks the navigation property as required (non-nullable).
        /// </summary>
        ...
        public NavigationPropertyConfiguration HasConstraint(KeyValuePair<PropertyInfo, PropertyInfo> constraint)
        {
            ...
            if (Multiplicity == EdmMultiplicity.ZeroOrOne || principal.NullableProperty)
            {
                dependent.NullableProperty = true;
            }
            ...
            if (Multiplicity == EdmMultiplicity.One && !principal.NullableProperty)
            {
                dependent.NullableProperty = false;
            }
