...
namespace Microsoft.OData.ModelBuilder.Capabilities.V1
{
	...
	public partial class DeepUpdateSupportConfiguration : VocabularyConfiguration
	{
        ...
        /// <summary>
        /// Creates a new instance of <see cref="DeepUpdateSupportConfiguration"/>
        /// </summary>
		public DeepUpdateSupportConfiguration()
			: base("Org.OData.Capabilities.V1.DeepUpdateSupport")
		{
		}
		...
		public DeepUpdateSupportConfiguration HasSupported(bool supported)
		{
		...
		/// <returns><see cref="DeepUpdateSupportConfiguration"/></returns>
		public DeepUpdateSupportConfiguration HasContentIDSupported(bool contentIDSupported)
		{
